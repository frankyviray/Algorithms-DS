...
// we have an array with tree.root (tree = new BinarySearchTree so it needs to be called instead of 'this'), 2nd param would be an empty array (Recursive function)
